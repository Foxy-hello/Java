                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="col-xs-10 addForm">
                            	<form:form cssClass="form-horizontal mb20" 
                            		action="${pageContext.request.contextPath}/addMeeting" 
                            		method="post"
                            		modelAttribute="mt">
                                    <div class="form-group">
                                        <label class="col-xs-2 control-label" for=""><s>*</s>会议名称</label>
                                        <div class="col-xs-8">
                                        	<form:input path="meetingName"  cssClass="form-control" placeholder="会议名称"/>
                                            <p class="help-inline text-muted"><form:errors path="meetingName" /></p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-xs-2 control-label" for=""><s>*</s>会议日期</label>
                                        <div class="col-xs-8">
                                        	<form:input type="date"  path="startTime"  cssClass="form-control w4" placeholder="开始日期"/>
                                            <span class="w1 text-center">至</span>
                                            <form:input type="date"  path="endTime"  cssClass="form-control w4" placeholder="结束日期"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-8 col-xs-offset-2 mt10">
                                            ...
                                            <p class="help-inline text-muted"><form:errors path="province" /></p>
                                       		<p class="help-inline text-muted"><form:errors path="city" /></p>
                                       		<p class="help-inline text-muted"><form:errors path="county" /></p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-8">
                                            ...
                                            <p class="help-inline text-muted"><form:errors path="contact" /></p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-8">
                                            ...
                                            <p class="help-inline text-muted"><form:errors path="telephone" /></p>
                                        </div>
                                    </div>    
                                     <div class="form-group">   
                                        ...
                                        <div class="col-xs-8">
                                            ...
                                            <p class="help-inline text-muted"><form:errors path="mobilephone" /></p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                      <label class="col-xs-2 control-label" for="">会议介绍</label>
                                        <div class="col-xs-8">
                                            ...
                                            <p class="help-inline text-muted"><form:errors path="introduce" /></p>
                                        </div>
                                    </div>            
                                    <div class="form-group">
                                        <div class="col-xs-offset-2 col-xs-8">
                                            <button type="submit" onclick="addMeeting()" class="btn btn-warning">新增会议</button>
                                        </div>
                                    </div>
                                </form:form>
                            </div>
