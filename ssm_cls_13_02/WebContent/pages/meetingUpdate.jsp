            ...
            <div class="row">
                ...
                <div class="col-xs-10">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">修改会议</div>
                        <div class="panel-body">
                            <div class="col-xs-10 addForm">
                                <form class="form-horizontal mb20" action="${pageContext.request.contextPath }/updateMeeting" method="post">
                                    <div class="form-group">
                                        <input type="hidden" name="id" value="${meet.id }" id="meetId">
                                        <label class="col-xs-2 control-label" for=""><s>*</s>会议名称</label>
                                        <div class="col-xs-8">
                                            <input type="text" class="form-control" placeholder="会议名称" name="meetingName" value="${meet.meetingName }">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-8">
                                            <input type="text" class="form-control w3" name="startTime" placeholder="开始日期" value="${meet.startTime }">
                                            <span class="w1 text-center">至</span>
                                            <input type="text" class="form-control w3" name="endTime" placeholder="结束日期" value="${meet.endTime }">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-8 col-xs-offset-2 mt10">
                                            <input type="text" class="form-control" name="address" placeholder="地址" value="${meet.address }">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-8">
                                            <input type="text" class="form-control" name="contact" placeholder="会议服务联系人" value="${meet.contact }">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-8">
                                            <input type="text" class="form-control w4" name="telephone" placeholder="区号-固定电话" value="${meet.telephone }">        
                                     ...
                                     <div class="form-group">   
                                        ...
                                        <div class="col-xs-8">
                                            <input type="text" class="form-control w4" name="mobilephone" placeholder="移动电话" value="${meet.mobilephone }">
                                    ...
                                    <div class="form-group">
                                      <label class="col-xs-2 control-label" for="">会议介绍</label>
                                        <div class="col-xs-8">
                                            <textarea class="form-control" rows="5" name="introduce">${meet.introduce }</textarea>
                                            <p class="help-inline text-muted">长度不低于2个字符，不多于100个字符</p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-xs-offset-2 col-xs-8">
                                            <button type="submit" class="btn btn-warning">编辑会议</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
